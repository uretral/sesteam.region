...
class BrinchPriceController extends Controller
{
    ...
    {
        $show = new Show(BrunchPrice::findOrFail($id));
    ...
    protected function form()
    {
        ...
        $form->tab('Настройки', function ($form) {
            ...
            if (request()->get('helpers')) {
                ...
                $tbl = BrunchPrice::where('id', \request()->segment(4));
