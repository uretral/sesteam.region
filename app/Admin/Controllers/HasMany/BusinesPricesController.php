...
namespace App\Admin\Controllers\HasMany;
...
class BusinesPricesController extends Controller
{
    ...
    {
        $grid = new Grid(new BusinessPrices);
    ...
    {
        $show = new Show(BusinessPrices::findOrFail($id));
    ...
    {
        $form = new Form(new BusinessPrices);
        ...
        $form->tab('Настройки', function ($form) {
            ...
            if (request()->get('helpers')) {
                ...
                $tbl = BusinessPrices::where('id', \request()->segment(4));
