...
use App\Models\Blocks\ResourceMenuIcons;
...
class ResourceMenuIconsController extends Controller
{
    ...
    {
        $grid = new Grid(new ResourceMenuIcons);
    ...
    {
        $show = new Show(ResourceMenuIcons::findOrFail($id));
    ...
    {
        $form = new Form(new ResourceMenuIcons);
