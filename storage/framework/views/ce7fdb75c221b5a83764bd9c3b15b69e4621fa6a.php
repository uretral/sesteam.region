<div class="box">
    ...
    <div class="box-header">
        ...
        <div class="btn-group pull-right">
            <a class="btn btn-success btn-sm" href="<?php echo e($path, false); ?>/create"><i class="fa fa-save"></i><span class="hidden-xs">&nbsp;<?php echo e(trans('admin.new'), false); ?></span></a>
        </div>
        <?php endif; ?>
...
<?php /**PATH /home/s/sesteam/region.sesteam.ru/vendor/encore/laravel-admin/src/../resources/views/tree.blade.php ENDPATH**/ ?>